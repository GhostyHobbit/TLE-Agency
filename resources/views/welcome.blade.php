    ...
    <main class="px-4 sm:px-8 py-8 space-y-12 bg-cream">
        ...
        <section class="relative">
            ...
            <div class="max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center lg:gap-12">
                <div class="lg:w-1/2">
                    <h2 class="text-h2 text-mossFoot mb-6">Iedereen kan meedoen</h2>
                    <p class="text-p text-mossDark leading-relaxed">
        ...
        <section class="max-w-7xl mx-auto space-y-12">
            <h2 class="text-h2 text-mossFoot mb-4 text-center">3 Principes van Open Hiring</h2>
            <div class="grid gap-12 lg:grid-cols-3">
                <!-- Principle 1 -->
                <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                    <h3 class="text-h3 text-mossFoot">1. Het werkt beter zonder (voor)oordelen</h3>
                    <p class="text-p text-mossDark leading-relaxed">
                        Met Open Hiring krijgen (voor)oordelen geen kans. En mensen die vaak (onbewust) worden
                        uitgesloten juist wel. Dat maakt de arbeidsmarkt eerlijker en mooier.
                    </p>
                </div>

                <!-- Principle 2 -->
                <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                    <h3 class="text-h3 text-mossFoot">2. We vertrouwen elkaar</h3>
                    <p class="text-p text-mossDark leading-relaxed">
                ...
                <!-- Principle 3 -->
                <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                    <h3 class="text-h3 text-mossFoot">3. Groeien doe je samen</h3>
                    <p class="text-p text-mossDark leading-relaxed">
        ...
        <div class="flex justify-center mt-12">
            <a href="{{ route('video') }}"
               class="w-72 h-20 bg-violet rounded-2xl border-b-2 border-violetDark flex items-center justify-between px-4 hover:bg-violetDark active:bg-violet">
                <span class="text-white text-buttonLink">Bekijk Video</span>
        ...
        <section class="px-4 sm:px-8 py-12 bg-cream">
            <div class="max-w-7xl mx-auto space-y-12">
                <div class="text-center">
                    <h2 class="text-h2 text-mossFoot mb-4">Hoe werkt Open Hiring?</h2>
                    <p class="text-p text-mossDark leading-relaxed">
                ...
                <div class="grid gap-12 lg:grid-cols-2">
                    <!-- Step 1 -->
                    <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                        <h3 class="text-h3 text-mossFoot">1. Kies een baan die bij je past</h3>
                        <p class="text-p text-mossDark leading-relaxed">
                    ...
                    <!-- Step 2 -->
                    <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                        <h3 class="text-h3 text-mossFoot">2. Meld je aan voor de lijst</h3>
                        <p class="text-p text-mossDark leading-relaxed">
                    ...
                    <!-- Step 3 -->
                    <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                        <h3 class="text-h3 text-mossFoot">3. Wacht op uitnodiging van de werkgever</h3>
                        <p class="text-p text-mossDark leading-relaxed">
                    ...
                    <!-- Step 4 -->
                    <div class="bg-mossLight shadow-md rounded-lg p-6 border border-strokeThin space-y-4">
                        <h3 class="text-h3 text-mossFoot">4. Begin met werken</h3>
                        <p class="text-p text-mossDark leading-relaxed">
        ...
        <div class="flex justify-center mt-12">
            <a href="{{ route('vacancies.index') }}"
               class="w-72 h-20 bg-violet rounded-2xl border-b-2 border-violetDark flex items-center justify-between px-4 hover:bg-violetDark active:bg-violet">
                <span class="text-white text-buttonLink">Bekijk vacatures</span>
                <img src="{{ asset('images/right-arrow-buttons.png') }}" alt="Sprite Icon" class="w-6 h-6">
            </a>
        </div>
    </main>
