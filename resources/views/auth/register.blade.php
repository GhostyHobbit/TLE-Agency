<x-nav>
    ...
    <div class="mx-auto w-full max-w-[90vw] mt-8 mb-0 p-0 rounded-lg !important">
        <h2 class="text-xl font-bold !text-[#2E342A] text-center">Registreren</h2>
        ...
        <div class="!text-[#2E342A] !important">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-6 bg-[#D9E6B1] p-4 rounded-lg !important">
                    ...
                    <x-text-input id="password" name="password" type="password" class="mt-1 block w-full !bg-white !text-[#2E342A] p-1" required autocomplete="new-password" />
                    <x-input-error class="mt-2 !text-[#2E342A]" :messages="$errors->get('password')" />
                </div>

                <!-- Confirm Password -->
                <div class="mb-6 bg-[#D9E6B1] p-4 rounded-lg !important">
                    <x-input-label class="!text-[#2E342A]" for="password_confirmation" :value="__('Herhaal wachtwoord')" />
                    <x-text-input id="password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full !bg-white !text-[#2E342A] p-1" required autocomplete="new-password" />
                    <x-input-error class="mt-2 !text-[#2E342A]" :messages="$errors->get('password_confirmation')" />
                </div>
                ...
                <div class="flex justify-center items-center mt-4 !important">
                    <a class="underline text-sm !text-[#2E342A] hover:!text-[#7c1a51] rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 !important" href="{{ route('login') }}">
