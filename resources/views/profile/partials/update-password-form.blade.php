<section class="p-6 rounded-lg shadow-lg bg-[#E2ECC8] mx-auto w-full max-w-[90vw] mt-8 mb-8">
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex justify-end items-center gap-4">
            <x-primary-button class="!w-[296px] !h-[53px] !px-[44.50px] !py-4 !bg-[#aa0160] !hover:bg-[#7c1a51] !active:bg-[#92AA83] !rounded-2xl !border-b-4 !border-[#7c1a51] !justify-center !items-center !inline-flex !text-[#fbfcf6] !text-base !font-bold !font-['Radikal'] !leading-snug">
                {{ __('Opslaan') }}
            </x-primary-button>
        </div>
