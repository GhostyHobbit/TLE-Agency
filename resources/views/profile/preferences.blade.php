        ...
        <div class="text-black">
            ...
            <form method="POST" action="{{ route('profile.preferences.update') }}">
                ...
                <div class="flex justify-center items-center">
                    <button
                        type="submit"
                        class="w-[296px] h-[53px] px-[44.50px] py-4 bg-[#aa0160] hover:bg-[#7c1a51] active:bg-[#92AA83] rounded-2xl border-b-4 border-[#7c1a51] justify-center items-center inline-flex text-[#fbfcf6] text-base font-bold font-['Radikal'] leading-snug"
